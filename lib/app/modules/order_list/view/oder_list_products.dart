import 'package:citgroupvn_efood_table/app/components/page_view/cart_widget.dart';
...
class OderListProducts extends StatefulWidget {
  const OderListProducts({super.key});

  @override
  State<OderListProducts> createState() => _OderListProductsState();
}

class _OderListProductsState extends State<OderListProducts> {
  ...
  @override
  void initState() {
    final mainTabViewController = Get.find<MainTabviewController>();
      ...
      child: Scaffold(
        ...
        appBar: ResponsiveHelper.isTab(context)
            ...
            : CommonAppBar(
                ...
                leadingIconColor: Theme.of(context).textTheme.bodyLarge?.color,
