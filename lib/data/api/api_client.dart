...
import 'package:citgroupvn_efood_table/data/model/response/error_response.dart';
...
class ApiClient extends GetxService {
  ...
  Future<Response> getData(String uri,
    ...
    try {
      String baseUrl = BaseCommon.instance.baseUrl ?? appBaseUrl!;

      debugPrint(
          '====> API Call: $baseUrl + $uri\n header: $_mainHeaders \n Token: $token');
